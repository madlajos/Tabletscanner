...
#define CUSTOM_MACHINE_NAME "Tablet Scanner"
...
//===========================================================================
// I Axis Pin Mapping — repurposing E2 (MOTOR 6) on BTT Octopus
//===========================================================================
#define I_STEP_PIN                      PE2   // E2_STEP (MOTOR 6)
#define I_DIR_PIN                       PE3   // E2_DIR
#define I_ENABLE_PIN                    PD4   // E2_ENABLE
#define I_CS_PIN                        PE1   // E2_CS
#define I_SERIAL_TX_PIN                 PE1   // E2 UART TX
#define I_SERIAL_RX_PIN                 PE1   // E2 UART RX (shared with TX for TMC220x)
#define I_DIAG_PIN                      PG14  // E2DET (shared with PWRDET)
#define I_MIN_PIN                       PG14  // E2DET (DIAG6) — hall sensor on Motor 6 slot
...
#define TEMP_SENSOR_BOARD 1   // Real thermistor for temperature monitoring (on TH1 / PF5)
#define TEMP_SENSOR_REDUNDANT 0

#define TEMP_BOARD_PIN                  PF5   // TH1 - temperature monitoring sensor pin
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1200, 8.89 }        // X, Y, Z, I(°)
// I calc: 200 steps/rev × 16 µsteps ÷ 360° = 8.889 steps/°
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 100, 2000 }              // X, Y, Z, I
...
#define Z_HOMING_HEIGHT  0      // (mm) No Z lift before homing XY
...
// :[0,1,2,3,4,5,6,7]
#define SOFT_PWM_SCALE 5  // ~244 Hz fan PWM; keeps the three lamp outputs independent
