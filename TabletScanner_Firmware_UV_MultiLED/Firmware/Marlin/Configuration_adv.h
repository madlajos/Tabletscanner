...
//
  ...
  #define BOARD_MINTEMP           -15  // (°C) Wide range for passive monitoring
  #define BOARD_MAXTEMP           120  // (°C) Wide range for passive monitoring
...
#define AXIS_RELATIVE_MODES { false, false, false, false }         // X, Y, Z, I
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 10*60 } // (mm/min, °/min) Feedrates for manual moves along X, Y, Z, I from panel
